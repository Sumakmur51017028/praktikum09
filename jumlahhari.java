...
public class jumlahhari extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agus", "September", "Oktober", "November", "Desember" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            BufferedWriter out = new BufferedWriter(new FileWriter("jumlahhari123.txt"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jumlahharilabel.setText("jumlah hari pada bulan  "
                + jComboBox1.getSelectedItem() + " tahun " + tahun + " adalah " + jumlahHari);
